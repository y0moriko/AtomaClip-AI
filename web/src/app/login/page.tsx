      ...
      <Card className="w-full max-w-md shadow-xl border-indigo-100">
        <CardHeader className="text-center pb-2">
          <Link href="/" className="inline-flex items-center gap-2 mb-6 mx-auto hover:opacity-80 transition-opacity">
            ...
            <span className="font-bold text-xl tracking-tight">AtomaClip</span>
          </Link>
        ...
        <CardContent className="space-y-6 pt-4">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link href="#" className="text-xs font-medium text-indigo-600 hover:text-indigo-700">Forgot?</Link>
              </div>
              <div className="relative">
          ...
          <div className="text-center text-sm">
            <span className="text-muted-foreground">New to AtomaClip?</span>{" "}
